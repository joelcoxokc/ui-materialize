(function (common) {
    ...
    function bytediffFormatter(data) {
        return data.fileName+' went from '+( data.startSize/1000 ).toFixed(2)+' kB to '+( data.endSize/1000 ).toFixed(2)
                 + ' kB and is '+common.formatPercent(1-data.percent, 2)+'%'+( data.savings>0 ? ' smaller.' : ' larger.' );  }
