...
module.exports = function (config) {
    config.set(
        ...
        , files: [ './src/client/test/lib/bindPolyfill.js'
        ...
        , exclude: [ './src/client/test/midway/**/*.spec.js' // Excluding midway tests for now; comment this line out when you want to run them
        ...
        , preprocessors: { 'src/client/app/**/*.js' : 'coverage' }
